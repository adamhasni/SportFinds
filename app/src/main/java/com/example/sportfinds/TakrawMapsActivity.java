...
public class TakrawMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_takraw_maps);
...
//        );
        //LIPAT KAJANG
        LatLng lipatKajang_area = new LatLng(2.273769,102.4439423);
        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(2.273769,102.4439423))
                .title("Lipat Kajang Perdana Takraw court")
        ...
        //MERLIMAU PASIR
        LatLng merlimauPasir_area = new LatLng(2.147144,102.4558648);
        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(2.147144,102.4558648))
                .title("Merlimau Pasir Takraw court")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET)));
        mMap.addCircle(new CircleOptions()
...
//        });
        ...
        //LIPAT KAJANG
        GeoQuery frescoQuery = geofire.queryAtLocation(new GeoLocation(lipatKajang_area.latitude, lipatKajang_area.longitude),1.0f);
        frescoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                sendNotification("SPORTFINDER", String.format("%s entered the Lipat Kajang Perdana Takraw court area", key));
            }

            @Override
            public void onKeyExited(String key) {
                sendNotification("SPORTFINDER", String.format("%s is no longer in the Lipat Kajang Perdana Takraw court area", key));
            }

            @Override
            public void onKeyMoved(String key, GeoLocation location) {
                Log.d("MOVE", String.format("%s moved within the Takraw court area[%f/%f]",key,location.latitude, location.longitude));
            }
        ...
        merlimauPQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                sendNotification("SPORTFINDER", String.format("%s entered the Merlimau Pasir Takraw court area", key));
            }

            @Override
            public void onKeyExited(String key) {
                sendNotification("SPORTFINDER", String.format("%s is no longer in the Merlimau Pasir Takraw court area", key));
            }
...
//        });
    ...
    private void sendNotification(String title, String content) {
        ...
        Intent intent = new Intent(this, TakrawMapsActivity.class);
